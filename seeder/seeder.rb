...
pages << {
    ...
    url: "https://www.naturesbasket.co.in/Handlers/SearchHandler.ashx?GetMoreSearchData=True&Keyword=&SupercategoryID=0&CategoryID=0&SubCategoryID=347&BrandID=&AttributeValueID=0&fromPrice=0&toPrice=400000&fromSize=1&toSize=100&UnitID=1&fromCount=1&SortID=1&DietaryId=&IsOutOfStock=&IsNewProduct=",
    vars: {
        'input_type' => 'taxonomy',
        'search_term' => '-',
        'page' => 1
